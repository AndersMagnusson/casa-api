...
// NewMagnussonHomeSecurityAPI creates a new MagnussonHomeSecurity instance
func NewMagnussonHomeSecurityAPI(spec *loads.Document) *MagnussonHomeSecurityAPI {
	return &MagnussonHomeSecurityAPI{
...
/*MagnussonHomeSecurityAPI the magnusson home security API */
type MagnussonHomeSecurityAPI struct {
	spec            *loads.Document
...
func (o *MagnussonHomeSecurityAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *MagnussonHomeSecurityAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *MagnussonHomeSecurityAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *MagnussonHomeSecurityAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *MagnussonHomeSecurityAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *MagnussonHomeSecurityAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *MagnussonHomeSecurityAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the MagnussonHomeSecurityAPI
func (o *MagnussonHomeSecurityAPI) Validate() error {
...
func (o *MagnussonHomeSecurityAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *MagnussonHomeSecurityAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *MagnussonHomeSecurityAPI) Authorizer() runtime.Authorizer {
...
func (o *MagnussonHomeSecurityAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *MagnussonHomeSecurityAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *MagnussonHomeSecurityAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the magnusson home security API
func (o *MagnussonHomeSecurityAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *MagnussonHomeSecurityAPI) initHandlerCache() {
...
func (o *MagnussonHomeSecurityAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *MagnussonHomeSecurityAPI) Init() {
	if len(o.handlers) == 0 {
		o.initHandlerCache()
	}
}
