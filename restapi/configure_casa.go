...
import (
	...
	alarmsFunc "casa/src/server/pkg/alarms"
	alertsFunc "casa/src/server/pkg/alerts"
	"casa/src/server/pkg/database"
	devicesFunc "casa/src/server/pkg/devices"
	discoveryFunc "casa/src/server/pkg/discovery"
	"casa/src/server/pkg/logging"
	"casa/src/server/pkg/status"
	"casa/src/server/pkg/subscribers"
